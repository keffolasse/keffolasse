...
!(function () {
    ...
    function c(a) {
        var b = { left: "start", right: "end", center: "middle", start: "start", end: "end" };
        return b[a] || b.start;
    }
    function d(a) {
        var b = { alphabetic: "alphabetic", hanging: "hanging", top: "text-before-edge", bottom: "text-after-edge", middle: "central" };
    ...
    (i = (function (a, b) {
        ...
        (e = {
            ...
            lineDash: { svgAttr: "stroke-dasharray", canvas: [], svg: null, apply: "stroke" },
        }),
        (g = function (a, b) {
        ...
        (g.prototype.addColorStop = function (b, c) {
            ...
            f.setAttribute("offset", b),
                -1 !== c.indexOf("rgba")
                    ? ((d = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi), (e = d.exec(c)), f.setAttribute("stop-color", a("rgb({r},{g},{b})", { r: e[1], g: e[2], b: e[3] })), f.setAttribute("stop-opacity", e[4]))
        ...
        (f = function (a) {
            ...
            (this.width = b.width || c.width),
                ...
                b.ctx ? (this.__ctx = b.ctx) : ((this.__canvas = this.__document.createElement("canvas")), (this.__ctx = this.__canvas.getContext("2d"))),
        ...
        (f.prototype.__applyStyleToCurrentElement = function (b) {
            ...
            for (f = 0; f < n.length; f++)
                if (((i = e[n[f]]), (j = this[n[f]]), i.apply))
                    if (j instanceof h) {
                    ...
                    } else if (j instanceof g) c.setAttribute(i.apply, a("url(#{id})", { id: j.__root.getAttribute("id") }));
                        ...
                        if (("stroke" !== i.svgAttr && "fill" !== i.svgAttr) || -1 === j.indexOf("rgba")) {
                            ...
                            (l = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi), (m = l.exec(j)), c.setAttribute(i.svgAttr, a("rgb({r},{g},{b})", { r: m[1], g: m[2], b: m[3] }));
                            var p = m[4],
                                q = this.globalAlpha;
        ...
        (f.prototype.__addTransform = function (a) {
            ...
            if (b.childNodes.length > 0) {
                "path" === this.__currentElement.nodeName &&
                    (this.__currentElementsToStyle || (this.__currentElementsToStyle = { element: b, children: [] }), this.__currentElementsToStyle.children.push(this.__currentElement), this.__applyCurrentDefaultPath());
        ...
        (f.prototype.scale = function (b, c) {
            void 0 === c && (c = b), this.__addTransform(a("scale({x},{y})", { x: b, y: c }));
        }),
        ...
        (f.prototype.moveTo = function (b, c) {
            "path" !== this.__currentElement.nodeName && this.beginPath(), (this.__currentPosition = { x: b, y: c }), this.__addPathCommand(a("M {x} {y}", { x: b, y: c }));
        }),
        (f.prototype.closePath = function () {
            this.__currentDefaultPath && this.__addPathCommand("Z");
        }),
        (f.prototype.lineTo = function (b, c) {
            (this.__currentPosition = { x: b, y: c }), this.__currentDefaultPath.indexOf("M") > -1 ? this.__addPathCommand(a("L {x} {y}", { x: b, y: c })) : this.__addPathCommand(a("M {x} {y}", { x: b, y: c }));
        }),
        (f.prototype.bezierCurveTo = function (b, c, d, e, f, g) {
            (this.__currentPosition = { x: f, y: g }), this.__addPathCommand(a("C {cp1x} {cp1y} {cp2x} {cp2y} {x} {y}", { cp1x: b, cp1y: c, cp2x: d, cp2y: e, x: f, y: g }));
        }),
        (f.prototype.quadraticCurveTo = function (b, c, d, e) {
            (this.__currentPosition = { x: d, y: e }), this.__addPathCommand(a("Q {cpx} {cpy} {x} {y}", { cpx: b, cpy: c, x: d, y: e }));
        });
    var j = function (a) {
    ...
    (f.prototype.arcTo = function (a, b, c, d, e) {
        ...
        (f.prototype.strokeRect = function (a, b, c, d) {
            var e, f;
            (e = this.__createElement("rect", { x: a, y: b, width: c, height: d }, !0)), (f = this.__closestGroupOrSvg()), f.appendChild(e), (this.__currentElement = e), this.__applyStyleToCurrentElement("stroke");
        }),
        ...
        (f.prototype.clearRect = function (a, b, c, d) {
            ...
            var e,
                f = this.__closestGroupOrSvg();
            (e = this.__createElement("rect", { x: a, y: b, width: c, height: d, fill: "#FFFFFF" }, !0)), f.appendChild(e);
        }),
        (f.prototype.createLinearGradient = function (a, c, d, e) {
            var f = this.__createElement("linearGradient", { id: b(this.__ids), x1: a + "px", x2: d + "px", y1: c + "px", y2: e + "px", gradientUnits: "userSpaceOnUse" }, !1);
            return this.__defs.appendChild(f), new g(f, this);
        }),
        (f.prototype.createRadialGradient = function (a, c, d, e, f, h) {
            var i = this.__createElement("radialGradient", { id: b(this.__ids), cx: e + "px", cy: f + "px", r: h + "px", fx: a + "px", fy: c + "px", gradientUnits: "userSpaceOnUse" }, !1);
        ...
        (f.prototype.__parseFont = function () {
            var a = /^\s*(?=(?:(?:[-a-z]+\s*){0,2}(italic|oblique))?)(?=(?:(?:[-a-z]+\s*){0,2}(small-caps))?)(?=(?:(?:[-a-z]+\s*){0,2}(bold(?:er)?|lighter|[1-9]00))?)(?:(?:normal|\1|\2|\3)\s*){0,3}((?:xx?-)?(?:small|large)|medium|smaller|larger|[.\d]+(?:\%|in|[cem]m|ex|p[ctx]))(?:\s*\/\s*(normal|[.\d]+(?:\%|in|[cem]m|ex|p[ctx])))?\s*([-,\'\"\sa-z0-9]+?)\s*$/i,
                b = a.exec(this.font),
                c = { style: b[1] || "normal", size: b[4] || "10px", family: b[6] || "sans-serif", weight: b[3] || "normal", decoration: b[2] || "normal", href: null };
        ...
        (f.prototype.__applyText = function (a, b, e, f) {
            var g = this.__parseFont(),
                ...
                i = this.__createElement(
                    "text",
                    { "font-family": g.family, "font-size": g.size, "font-style": g.style, "font-weight": g.weight, "text-decoration": g.decoration, x: b, y: e, "text-anchor": c(this.textAlign), "dominant-baseline": d(this.textBaseline) },
                    !0
                );
        ...
        (f.prototype.arc = function (b, c, d, e, f, g) {
            if (e !== f) {
                ...
                n < 0 && (n += 2 * Math.PI),
                    ...
                    this.lineTo(j, k),
                    this.__addPathCommand(a("A {rx} {ry} {xAxisRotation} {largeArcFlag} {sweepFlag} {endX} {endY}", { rx: d, ry: d, xAxisRotation: 0, largeArcFlag: m, sweepFlag: l, endX: h, endY: i })),
        ...
        (f.prototype.drawImage = function () {
            ...
            if (q instanceof f) {
                ...
                ("CANVAS" !== q.nodeName && "IMG" !== q.nodeName) ||
                    ...
                    (r || s || e !== q.width || g !== q.height) && ((m = this.__document.createElement("canvas")), (m.width = c), (m.height = d), (n = m.getContext("2d")), n.drawImage(q, r, s, e, g, 0, 0, c, d), (q = m)),
        ...
        (f.prototype.createPattern = function (a, c) {
            ...
            return (
                ...
                "CANVAS" === a.nodeName || "IMG" === a.nodeName
                    ? ((d = this.__document.createElementNS("http://www.w3.org/2000/svg", "image")),
                    ...
                    : a instanceof f && (e.appendChild(a.__root.childNodes[1]), this.__defs.appendChild(e)),
                new h(e, this)
            );
        }),
    ...
    function () {
        ...
        function a(a, b) {
            ...
            for (var c = 0, d = this.data.length; c < d; c++) {
                var e = [],
                    f = this.data.charCodeAt(c);
                b
                    ? (e[0] = f)
                    : f > 65536
                    ? ((e[0] = 240 | ((1835008 & f) >>> 18)), (e[1] = 128 | ((258048 & f) >>> 12)), (e[2] = 128 | ((4032 & f) >>> 6)), (e[3] = 128 | (63 & f)))
                    : f > 2048
                    ? ((e[0] = 224 | ((61440 & f) >>> 12)), (e[1] = 128 | ((4032 & f) >>> 6)), (e[2] = 128 | (63 & f)))
                    : f > 128
                    ? ((e[0] = 192 | ((1984 & f) >>> 6)), (e[1] = 128 | (63 & f)))
                    : (e[0] = f),
                        ...
                        if (!(a + d <= -1 || this.moduleCount <= a + d))
                            for (var e = -1; e <= 7; e++)
                                b + e <= -1 ||
                                    ...
                                    ((0 <= d && d <= 6 && (0 == e || 6 == e)) || (0 <= e && e <= 6 && (0 == d || 6 == d)) || (2 <= d && d <= 4 && 2 <= e && e <= 4)
                                        ? ((this.modules[a + d][b + e][0] = !0), (this.modules[a + d][b + e][2] = c), (this.modules[a + d][b + e][1] = -0 == d || -0 == e || 6 == d || 6 == e ? "O" : "I"))
                                ...
                                for (var g = -2; g <= 2; g++)
                                    for (var h = -2; h <= 2; h++)
                                        -2 == g || 2 == g || -2 == h || 2 == h || (0 == g && 0 == h)
                                            ? ((this.modules[e + g][f + h][0] = !0), (this.modules[e + g][f + h][2] = a), (this.modules[e + g][f + h][1] = -2 == g || -2 == h || 2 == g || 2 == h ? "O" : "I"))
                ...
                ? (function () {
                      function a() {
                          ...
                          this._htOption.onRenderingEnd &&
                              (this.dataURL || console.error("Can not get base64 data, please check: 1. Published the page and image to the server 2. The image request support CORS 3. Configured `crossOrigin:'anonymous'` option"),
                      ...
                      function b(a, b) {
                          ...
                          if (((c._fFail = b), (c._fSuccess = a), null === c._bSupportDataURI)) {
                              ...
                              return (
                                  (d.onabort = e), (d.onerror = e), (d.onload = f), void (d.src = "data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==")
                              );
                          }
                      ...
                      var e = function (a, b) {
                          (this._bIsPainted = !1),
                              ...
                              "svg" == this._htOption.drawer
                                  ...
                                  : ((this._elCanvas = document.createElement("canvas")), this._el.appendChild(this._elCanvas), (this._oContext = this._elCanvas.getContext("2d"))),
                          ...
                          (e.prototype.draw = function (a) {
                              ...
                              function c(a) {
                                  function c(a) {
                                      ...
                                      var f, g;
                                      void 0 === a.naturalWidth ? ((f = a.width), (g = a.height)) : ((f = a.naturalWidth), (g = a.naturalHeight)),
                                  ...
                                  for (var i = 0; i < e; i++)
                                      for (var j = 0; j < e; j++) {
                                          ...
                                          var p, q;
                                          n
                                              ? ((p = d[n.type] || d[n.type.substring(0, 2)] || d.colorDark), (q = d.colorLight))
                                              : d.backgroundImage
                                              ? ((q = "rgba(0,0,0,0)"),
                                                6 == i
                                                    ? d.autoColor
                                                        ? ((p = d.timing_H || d.timing || d.autoColorDark), (q = d.timing_H || d.timing || d.autoColorLight))
                                                        : (p = d.timing_H || d.timing || d.colorDark)
                                                    : 6 == j
                                                    ? d.autoColor
                                                        ? ((p = d.timing_V || d.timing || d.autoColorDark), (q = d.timing_V || d.timing || d.autoColorLight))
                                                        : (p = d.timing_V || d.timing || d.colorDark)
                                                    : d.autoColor
                                                    ? ((p = d.autoColorDark), (q = d.autoColorLight))
                                                    : (p = d.colorDark))
                                              : ((p = 6 == i ? d.timing_H || d.timing || d.colorDark : 6 == j ? d.timing_V || d.timing || d.colorDark : d.colorDark), (q = d.colorLight)),
                                              (h.strokeStyle = m ? p : q),
                                              (h.fillStyle = m ? p : q),
                                              n
                                                  ? ((o = "AO" == n.type ? d.dotScaleAO : "AI" == n.type ? d.dotScaleAI : 1),
                                                    d.backgroundImage && d.autoColor ? ((p = ("AO" == n.type ? d.AI : d.AO) || d.autoColorDark), (q = d.autoColorLight)) : (p = ("AO" == n.type ? d.AI : d.AO) || p),
                                                    (m = n.isDark),
                                                    h.fillRect(k + (f * (1 - o)) / 2, d.titleHeight + l + (g * (1 - o)) / 2, f * o, g * o))
                                                  : 6 == i
                                                  ? ((o = d.dotScaleTiming_H), h.fillRect(k + (f * (1 - o)) / 2, d.titleHeight + l + (g * (1 - o)) / 2, f * o, g * o))
                                                  : 6 == j
                                                  ? ((o = d.dotScaleTiming_V), h.fillRect(k + (f * (1 - o)) / 2, d.titleHeight + l + (g * (1 - o)) / 2, f * o, g * o))
                              ...
                              if (d.backgroundImage) {
                                  var j = new Image();
                                  (j.onload = function () {
                                      (h.globalAlpha = 1), (h.globalAlpha = d.backgroundImageAlpha), h.drawImage(j, 0, d.titleHeight, d.width + 2 * d.quietZone, d.height + 2 * d.quietZone - d.titleHeight), (h.globalAlpha = 1), c.call(i, a);
                                  }),
                ...
                : (function () {
                      ...
                      return (
                          (a.prototype.draw = function (a) {
                              ...
                              if (
                                  (b.quietZone && (h = "display:inline-block; width:" + (b.width + 2 * b.quietZone) + "px; height:" + (b.width + 2 * b.quietZone) + "px;background:" + b.quietZoneColor + "; text-align:center;"),
                              ...
                              for (var p = 0; p < d; p++) {
                                  ...
                                  for (var q = 0; q < d; q++) {
                                      ...
                                      if (s) {
                                          ...
                                          var v = b.colorDark;
                                          6 == p
                                              ? ((v = b.timing_H || b.timing || k), g.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + e + "px;height:" + f + "px;background-color:" + (r ? v : l) + ';"></td>'))
                                              : 6 == q
                                              ? ((v = b.timing_V || b.timing || k), g.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + e + "px;height:" + f + "px;background-color:" + (r ? v : l) + ';"></td>'))
                                              : g.push(
                                                    '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                                                        e +
                                                        "px;height:" +
        ...
        (j = function (a, b) {
            ...
            (this._htOption.version < 0 || this._htOption.version > 40) && (console.warn("QR Code version '" + this._htOption.version + "' is invalidate, reset to 0"), (this._htOption.version = 0)),
                (this._htOption.dotScale < 0 || this._htOption.dotScale > 1) &&
                    (console.warn(this._htOption.dotScale + " , is invalidate, dotScale must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScale = 1)),
                (this._htOption.dotScaleTiming < 0 || this._htOption.dotScaleTiming > 1) &&
                    (console.warn(this._htOption.dotScaleTiming + " , is invalidate, dotScaleTiming must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleTiming = 1)),
                this._htOption.dotScaleTiming_H
                    ? (this._htOption.dotScaleTiming_H < 0 || this._htOption.dotScaleTiming_H > 1) &&
                      (console.warn(this._htOption.dotScaleTiming_H + " , is invalidate, dotScaleTiming_H must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleTiming_H = 1))
                    : (this._htOption.dotScaleTiming_H = this._htOption.dotScaleTiming),
                this._htOption.dotScaleTiming_V
                    ? (this._htOption.dotScaleTiming_V < 0 || this._htOption.dotScaleTiming_V > 1) &&
                      (console.warn(this._htOption.dotScaleTiming_V + " , is invalidate, dotScaleTiming_V must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleTiming_V = 1))
                    : (this._htOption.dotScaleTiming_V = this._htOption.dotScaleTiming),
                (this._htOption.dotScaleA < 0 || this._htOption.dotScaleA > 1) &&
                    (console.warn(this._htOption.dotScaleA + " , is invalidate, dotScaleA must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleA = 1)),
                this._htOption.dotScaleAO
                    ? (this._htOption.dotScaleAO < 0 || this._htOption.dotScaleAO > 1) &&
                      (console.warn(this._htOption.dotScaleAO + " , is invalidate, dotScaleAO must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleAO = 1))
                    : (this._htOption.dotScaleAO = this._htOption.dotScaleA),
                this._htOption.dotScaleAI
                    ? (this._htOption.dotScaleAI < 0 || this._htOption.dotScaleAI > 1) &&
                      (console.warn(this._htOption.dotScaleAI + " , is invalidate, dotScaleAI must greater than 0, less than or equal to 1, now reset to 1. "), (this._htOption.dotScaleAI = 1))
                    : (this._htOption.dotScaleAI = this._htOption.dotScaleA),
                (this._htOption.backgroundImageAlpha < 0 || this._htOption.backgroundImageAlpha > 1) &&
                    (console.warn(this._htOption.backgroundImageAlpha + " , is invalidate, backgroundImageAlpha must between 0 and 1, now reset to 1. "), (this._htOption.backgroundImageAlpha = 1)),
            ...
            (j.prototype.makeCode = function (a) {
                (this._oQRCode = new b(g(a, this._htOption), this._htOption.correctLevel)),
                    this._oQRCode.addData(a, this._htOption.binary),
                    this._oQRCode.make(),
