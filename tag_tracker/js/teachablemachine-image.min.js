...
var tmImage = function(t) {
    ...
    e.resize = o, e.resizeMaxTo = function(t, e, n) {
        ...
        return p.drawImage(t, -1 * ~~(l / 2), -1 * ~~(f / 2), u, c), n && (p.scale(-0.5, 0.5), p.drawImage(o, -1 * u, 0)), o
    }
}, function(t, e, n) {
    "use strict";
        ...
        l = function() {
            ...
            return t.prototype.getWebcam = function(t) {
                ...
                if (this.canvas && this.webcam) {
                    ...
                    this.flip ? (t.save(), t.scale(-0.5, 0.5), t.drawImage(this.webcam, -this.webcam.width, 0), t.restore()) : t.drawImage(this.webcam, 0, 0)
                }
