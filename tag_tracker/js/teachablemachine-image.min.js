...
var tmImage = function(t) {
            ...
            return void 0 === n && (n = !1), r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                        ...
                        case 1:
                            for (l = o.sent(), f = [], p = 0; p < l.length; p++) f.push({
    ...
    e.CustomMobileNet = v, e.loadTruncatedMobileNet = function(t) {
        return r(this, void 0, void 0, (function() {
            ...
            return o(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return e = p(t), n = e[0], r = e[1], [4, i.loadLayersModel(n)];
                    case 1:
    ...
    e.resize = o, e.resizeMaxTo = function(t, e, n) {
        ...
        return p.drawImage(t, -1 * ~~(l / 2), -1 * ~~(f / 2), u, c), n && (p.scale(-1, 1), p.drawImage(o, -1 * u, 0)), o
    }
}, function(t, e, n) {
    "use strict";
    ...
    var d = function(t) {
        ...
        return o(e, t), Object.defineProperty(e.prototype, "asSequentialModel", {
                ...
                return a(this, (function(a) {
                    switch (a.label) {
                        case 0:
                            ...
                            return f = this.trainDataset.batch(t.batchSize), p = this.validationDataset.batch(t.batchSize), [4, this.trainingModel.fitDataset(f, {
                                epochs: t.epochs,
                                validationData: p,
                                callbacks: e
                            })];
                        case 1:
                            return a.sent(), (d = s.sequential()).add(this.truncatedModel), d.add(this.trainingModel), this.model = d, l.dispose(), [2, this.model]
                    }
                }))
            }))
            ...
            return i(this, void 0, void 0, (function() {
                var t, e, n, r, o, u, c, l, f, p, d, h, v, y, b, m, g, w, x = this;
                return a(this, (function(_) {
                    switch (_.label) {
                        ...
                        case 4:
                            return d = _.sent(), h = this.trainingModel.predict(d.value), v = h.argMax(1), f.push(v), [4, l.next()];
                        case 5:
                            y = _.sent(), b = y.value.argMax(1), p.push(b), d.value.dispose(), h.dispose(), y.value.dispose(), _.label = 6;
                        case 6:
                            return w++, [3, 3];
                        case 7:
                            if (m = s.concat(p), g = s.concat(f), 1 !== r)
                                for (w = 0; w < f.length; w++) f[w].dispose(), p[w].dispose();
                            return [2, {
                                reference: m,
                                predictions: g
                            }]
    ...
    ! function(o, i) {
        ...
        function v(t, e, n) {
            var r = [],
                ...
                v = new y(r),
                w = function() {
                    for (var t = v.g(c), e = f, n = 0; t < p;) t = (t + n) * u, e *= u, n = v.g(1);
                    for (; t >= d;) t /= 2, e /= 2, n >>>= 1;
                    return (t + n) / e
                };
    ...
    var a = n(20),
        ...
        l = function() {
            function t(t, e, n) {
                void 0 === t && (t = 100), void 0 === e && (e = 100), void 0 === n && (n = !1), this.width = t, this.height = e, this.flip = n
            }
            return t.prototype.getWebcam = function(t) {
                ...
                var n = function(t) {
                        return t.facingMode = t.facingMode || s, t.frameRate = t.frameRate || u, t.aspectRatio = t.aspectRatio || c, t
                    }(t),
                    r = document.createElement("video");
                return window.navigator.mediaDevices.getUserMedia({
                    video: n
                }).then((function(t) {
                    return r.srcObject = t, r.width = e.width, r.height = e.height, r
                }), (function() {
                ...
                if (this.canvas && this.webcam) {
                    ...
                    this.flip ? (t.save(), t.scale(-1, 1), t.drawImage(this.webcam, -this.webcam.width, 0), t.restore()) : t.drawImage(this.webcam, 0, 0)
                }
